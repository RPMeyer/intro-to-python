...
def createPattern(magVal,color1,color2, times):
    ...
    shapeSize=61*magVal
    bounds=shapeSize*times*times #useful in determining if turtle is out of bounds, but primarily used to get screensize
    ...
    while(True):
        testTurt.goto(shapeSize*squareCount,0) #prevents turtle from creating squares on top of squares on top of squares, and moves appropriate x-distance

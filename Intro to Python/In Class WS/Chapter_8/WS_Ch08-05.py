# Ws ch8_5
#
# Write a function, count_words_in(Sentence), what returns the number of
# words in Sentence that have between 3 and 7 letters and which contain at least
# 2 vowels, where vowels are taken to be the letters {‘a’,’e’,’I’,’o’,’u’}.
#-------------------------------------
